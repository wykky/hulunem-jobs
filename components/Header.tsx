      ...
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center gap-4">
        <a href="/" className="flex items-center gap-2 shrink-0">
          ...
          <span className="font-semibold text-sm sm:text-base">
            ...
            <span className="text-muted hidden sm:inline">Jobs</span>
          </span>
        </a>
        <nav className="flex gap-4 sm:gap-6 text-sm text-muted items-center overflow-x-auto no-scrollbar flex-1 min-w-0">
          <a href="/" className="shrink-0 hover:text-accent">Jobs</a>
          <a href="/skills" className="shrink-0 hover:text-accent">Skills</a>
          <a href="/submit" className="shrink-0 hover:text-accent">Post a Job</a>
